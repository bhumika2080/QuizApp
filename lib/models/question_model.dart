...
// returns just one of the data, so one data per page

// class ApiCalling {
//   String url = "https://the-trivia-api.com/v2/questions";

//   Future<Trivia?> getData() async {
//     http.Response response = await http.get(Uri.parse(url));
//     if (response.statusCode == 200 ||
//         response.statusCode == 201 ||
//         response.statusCode == 202) {
...
//       // Check if the JSON response is a non-empty list
//       if (jsonBody is List && jsonBody.isNotEmpty) {
//         // Return the first element of the list as a Trivia object
//         return Trivia.fromJson(jsonBody.first);
//       }
//     }
    
//     // Return null if there's an issue or the response is empty
//     return null;
//   }
// }
